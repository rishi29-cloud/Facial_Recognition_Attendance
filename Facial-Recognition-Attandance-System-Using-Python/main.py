...
message = tk.Label(window, text="Face-Recognition-Attendance"  ,fg="black", bg="grey"  ,font=('times', 30, 'italic bold underline')) 
...
datetime_label = tk.Label(window, text="", bg="grey", font=('times', 15, 'bold'))
datetime_label.place(x=50, y=650)
update_datetime()


def CaptureLiveAttendance():
...
attendance_label = tk.Label(window, text="Present Students: 0", bg="grey", font=('times', 15, 'bold'))
attendance_label.place(x=50, y=700)
...
captureLiveAttendance = tk.Button(window, text="Capture Live Attendance", command=CaptureLiveAttendance, width=20, height=2, activebackground="Red", font=('times', 15, ' bold '))
captureLiveAttendance.place(x=1200, y=600)
